locals {
  batch-instance_percent = 20
  unhealthy_instance_percent = 20
  unhealthy_upgraded = 5
  pause_time = "PT0S"
...
resource "azurerm_virtual_machine_scale_set" "vmss" {
  ...
  network_profile {
    ...
    ip_configuration {
      ...
      load_balancer_backend_address_pool_ids = [azurerm_application_gateway.apg.gateway_ip_configuration[0].id]
    }
  }
  tags = {
